...
const KO_DB: LocalFood[] = [
  ...
  { id: 'local-pork-loin', name: '돼지 목살', aliases: ['pork loin', 'pork shoulder'], source: 'custom', calories100g: 271, carbs100g: 0, protein100g: 18.0, fat100g: 22.0, servingSize: 150, servingLabel: '1인분 (150g)' },
  // 생선/해산물
